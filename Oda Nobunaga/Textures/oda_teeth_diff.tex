...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ5Mod\Leaderhead_Work\HQ_Textures\oda\oda_teeth_diff.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2603003395</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="oda_teeth_diff.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="oda_teeth_diff"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
